...
# create vpc module
module "vpc" {
  source                       = "git@github.com:hashim1sharif/terraform-modules.git//vpc"
  region                       = local.region
...
module "security_group" {
  source       = "git@github.com:hashim1sharif/terraform-modules.git//security-group"
  project_name = local.project_name
  environment  = local.environment
  vpc_id       = module.vpc.vpc_id
  ssh_ip       = var.ssh_ip
...
module "application_load_balancer" {
  source                = "git@github.com:hashim1sharif/terraform-modules.git//alb"
  project_name          = local.project_name
  environment           = local.environment
  alb_security_group_id = module.security_group.alb_security_group_id
  public_subnet_id_1    = module.vpc.public_subnet_az1_id
  public_subnet_id_2    = module.vpc.public_subnet_az2_id
